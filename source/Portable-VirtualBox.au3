...
If NOT FileExists(@ScriptDir&"\data\tools\7za.exe") Then DownloadGithub("http://raw.githubusercontent.com/Deac2/Portable-VirtualBox/refs/heads/resource/data/tools/7za.exe", "data/tools/7za.exe")
If @OSArch = "x86" AND NOT FileExists(@ScriptDir&"\data\tools\snetcfg_x86.exe") Then DownloadGithub("http://raw.githubusercontent.com/Deac2/Portable-VirtualBox/refs/heads/resource/data/tools/snetcfg_x86.exe", "data/tools/snetcfg_x86.exe")
If @OSArch = "x64" AND NOT FileExists(@ScriptDir&"\data\tools\snetcfg_x64.exe") Then DownloadGithub("http://raw.githubusercontent.com/Deac2/Portable-VirtualBox/refs/heads/resource/data/tools/snetcfg_x64.exe", "data/tools/snetcfg_x64.exe")
If @OSArch = "x86" AND NOT FileExists(@ScriptDir&"\data\tools\devcon_x86.exe") Then DownloadGithub("http://raw.githubusercontent.com/Deac2/Portable-VirtualBox/refs/heads/resource/data/tools/devcon_x86.exe", "data/tools/devcon_x86.exe")
If @OSArch = "x64" AND NOT FileExists(@ScriptDir&"\data\tools\devcon_x64.exe") Then DownloadGithub("http://raw.githubusercontent.com/Deac2/Portable-VirtualBox/refs/heads/resource/data/tools/devcon_x64.exe", "data/tools/devcon_x64.exe")
...
If $new1 = 1 OR $new2 = 1 Then
  ...
  If $new1 = 1 AND $new2 = 0 Then
    Local $dialog = IniRead($Dir_Lang & $lng &".ini", "check", "02", "NotFound") &" "& $ov_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "06", "NotFound") &" "& $nv_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "07", "NotFound")
  EndIf

  If $new1 = 0 AND $new2 = 1 Then
    Local $dialog = IniRead($Dir_Lang & $lng &".ini", "check", "03", "NotFound") &" "& $os_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "06", "NotFound") &" "& $ns_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "07", "NotFound")
  EndIf

  If $new1 = 1 AND $new2 = 1 Then
    Local $dialog = IniRead($Dir_Lang & $lng &".ini", "check", "04", "NotFound") &" "& $ov_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "06", "NotFound") &" "& $nv_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "05", "NotFound") &" "& $os_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "06", "NotFound") &" "& $ns_d &" "& IniRead($Dir_Lang & $lng &".ini", "check", "07", "NotFound")
  EndIf

  GUICreate(IniRead($Dir_Lang & $lng &".ini", "check", "01", "NotFound"), 300, 190, -1, -1, $WS_POPUP)
  ...
  $Checkbox200 = GUICtrlCreateCheckbox(IniRead($Dir_Lang & $lng &".ini", "check", "08", "NotFound"), 14, 62, 260, 14)

  GUICtrlCreateLabel(IniRead($Dir_Lang & $lng &".ini", "check", "09", "NotFound"), 14, 82, 280, 10)
  GUICtrlSetFont(-1, 8, 800, 4,"Arial")
  $Input300 = GUICtrlCreateLabel("", 14, 96, 260, 20)
  GUICtrlSetFont(-1, 8, 400, 0,"Arial")

  GUICtrlCreateButton(IniRead($Dir_Lang & $lng &".ini", "check", "10", "NotFound"), 32, 116, 100, 33, 0)
  GUICtrlSetFont(-1, 9, 800, "Arial")
  GUICtrlSetOnEvent(-1, "UpdateYes")
  GUICtrlCreateButton(IniRead($Dir_Lang & $lng &".ini", "check", "11", "NotFound"), 160, 116, 100, 33, 0)
  GUICtrlSetFont(-1, 9, 800, "Arial")
